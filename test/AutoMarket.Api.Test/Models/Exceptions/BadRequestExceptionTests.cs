...
namespace AutoMarket.Api.Test.Models.Exceptions
{
    public class BadRequestExceptionTests
    {
        ...
        private readonly string _expectedTitle = ExceptionMessageKeyConstants.BAD_REQUEST_TITLE;
        private readonly string _expectedDetail = ExceptionMessageKeyConstants.BAD_REQUEST_DETAIL;
        ...
        public void Constructor_ShouldAssertTrue_TitleAndMessageList(string title, string message)
        {
            ...
            //Act
            var result = new BadRequestException(messageList, title);
        ...
        {
            //Act
            var result = new BadRequestException(message, title);
