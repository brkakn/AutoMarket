...
namespace AutoMarket.Api.Test.Models.Exceptions
{
    public class InternalServerExceptionTests
    {
        ...
        private readonly string _expectedTitle = ExceptionMessageKeyConstants.INTERNAL_SERVER_TITLE;
        private readonly string _expectedDetail = ExceptionMessageKeyConstants.INTERNAL_SERVER_DETAIL;
        ...
        {
            //Act
            var result = new InternalServerErrorException(message);
        ...
        public void Constructor_ShouldAssertTrue_MessageList(string message)
        {
            ...
            //Act
            var result = new InternalServerErrorException(messageList);
        ...
        public void Constructor_ShouldAssertTrue_TitleAndMessageList(string title, string message)
        {
            ...
            //Act
            var result = new InternalServerErrorException(messageList, title);
        ...
        {
            //Act
            var result = new InternalServerErrorException(message, title);
